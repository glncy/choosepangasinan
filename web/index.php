...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner  navbar-collapse collapse" role="listbox">
    ...
    <div class="col-sm-6" style="padding: 10px;">
        <div class="hovereffect">
            <a href="top.php"><img class="img-responsive" src="images/td/see.png" alt="" width="100%"></a>
                <a href="top.php"style="text-decoration: none; font-family: Title;">
                <div class="overlay">
                </div>
                
            <div class="carousel-caption">
                    <div style="font-family: Title; font-size: 4.0vw; top: 20px; position: relative;">SEE MORE!</div></a>
            </div>
        </div>
    </div>
    </div>
